...
1. Open **My Page → Creator Studio**, create an OC Maker in **Your OC Makers**, or open an existing draft.
...
9. Add incompatible-choice logic in **Rules** and shared color controls in **Palette Rules**.
10. Run **Preview Check**. Every public Item must have at least one PNG, every rule must point to an existing Part, and at least one Part must be visible.
