  ...
  en: {
    ...
    articles: [
      ...
      },
      {
        ...
        summary: 'Publish an independent free or one-time-paid additive release bound to one exact parent Maker release.',
        sections: [
          {
            title: 'Independent release and access',
            bullets: [
              'Every publication creates an independent ExpansionPackReleaseV8 bound to the exact parent MakerRootV5, parent release object, parent version, manifest Blob/Quilt id, and manifest SHA-256.',
              'Pack Studio inherits the parent canvas, Renderer, Layer Tracks, Rules, Smart Color, Soul, license, and other compatibility contracts as read-only context. The creator edits only Pack-owned additive Parts, Items, and Styles.',
              'Choose FREE or ONE_TIME_PAID. A free claim or exact one-time payment issues a permanent, non-transferable, wallet-bound ExpansionPackPassV8 for that Pack release.',
              'Using a Pack also requires the parent Base entitlement, an Active Pack, and an admission matching the parent’s current ownership epoch.',
            ],
          },
          {
            title: 'Admission, boundaries, and versions',
            bullets: [
              'After the exact Style registry is sealed, the current parent operator admits the Pack with the live MakerControlCapV5. Admission records the parent ownership epoch.',
              'A Maker transfer changes that epoch, so new claims, purchases, and Pack access fail closed until the new operator re-admits the Pack. Existing Passes and entitlement records are preserved rather than silently revoked.',
              'A Pack may only add Pack-owned content and compatible Pack-owned rules. It cannot replace the default Recipe or mutate parent artwork, Rules, Layer Tracks, Smart Color, Soul, license, or other inherited contracts.',
              'Changing Pack content creates a new immutable Pack version and ExpansionPackReleaseV8. It does not create a new Maker version, rewrite the parent release, or alter an older Pack release.',
            ],
            note: 'A Pack is an independently administered child release with its own identity, lifecycle, access Passes, and Treasury. It is bound to a parent Maker release, but it is not a nested Maker. Expansion Pack v8 remains fail-closed until its package, runtime ids, and Mainnet evidence are verified.',
          },
          {
            title: 'Player installation and protected artwork',
            bullets: [
              'The Player lists only Pack releases whose Sui object, exact parent release, canonical Walrus manifest, full Style registry, and wallet Pass all agree. A matching name or local draft never grants access.',
              'Claim a FREE Pack or purchase a ONE_TIME_PAID Pack once, then enable or disable that exact release in the Player. Saved sessions pin the release object, Pack version, manifest SHA-256, content commitment, and parent version.',
              'Paid Style PNGs are uploaded as Seal ciphertext. The Player verifies the plaintext commitment, ciphertext digest, deterministic Seal id, key-server policy, and wallet entitlement before decrypting; failed evidence keeps the Pack unavailable.',
              'Independent Pack artwork can be previewed and mixed in the Player. Complete OC remains blocked while such a Pack is enabled until the reviewed composite-Complete bridge is deployed and enabled on-chain.',
            ],
          },
        ],
      },
  ...
  zh: {
    ...
    articles: [
      ...
      },
      {
        ...
        category: 'publish',
        title: 'Expansion Packs',
        summary: '发布独立的免费或一次付费增量版本，并精确绑定一个母 Maker 版本。',
        sections: [
          {
            title: '独立版本与访问权',
            bullets: [
              '每次发布都会创建独立 ExpansionPackReleaseV8，并精确绑定母 MakerRootV5、母版本对象、母版本号、manifest Blob/Quilt id 与 manifest SHA-256。',
              'Pack Studio 只读继承母版的画布、Renderer、Layer Tracks、Rules、Smart Color、Soul、许可与其他兼容性契约；创作者只能编辑 Pack 自有的增量 Part、Item 和 Style。',
              '访问模式只能选择 FREE 或 ONE_TIME_PAID。免费领取或精确的一次付费都会签发永久、不可转让且绑定钱包的 ExpansionPackPassV8。',
              '使用 Pack 还要求玩家拥有母版 Base 权限、Pack 处于 Active，并且准入记录匹配母版当前 ownership epoch。',
            ],
          },
          {
            title: '准入、边界与版本',
            bullets: [
              '精确 Style 注册表封存后，由母版当前经营者使用有效 MakerControlCapV5 准入 Pack；准入会记录母版 ownership epoch。',
              'Maker 转让会改变该 epoch；新经营者重新准入之前，新的领取、购买和 Pack 使用都会 fail closed。既有 Pass 与权限记录会保留，不会被静默撤销。',
              'Pack 只能增加自有内容与兼容的 Pack 自有规则，不能替换默认 Recipe，也不能改动母版素材、Rules、Layer Tracks、Smart Color、Soul、许可或其他继承契约。',
              '修改 Pack 内容会创建新的不可变 Pack 版本和 ExpansionPackReleaseV8；不会创建 Maker 新版本，也不会改写母版本或旧 Pack 版本。',
            ],
            note: 'Pack 是拥有独立身份、生命周期、访问 Pass 与 Treasury 的子版本。它绑定母 Maker 版本，但不是 Maker 套 Maker。在 package、runtime id 与主网证据完成验证前，Expansion Pack v8 保持 fail-closed。',
          },
          {
            title: '玩家安装与付费素材保护',
            bullets: [
              '玩家端只展示以下证据完全一致的 Pack：Sui Release 对象、精确母版本、Walrus 规范 manifest、完整 Style 注册表和钱包 Pass。名称相同或本地草稿绝不能授予权限。',
              'FREE Pack 需要领取，ONE_TIME_PAID Pack 只需购买一次；随后玩家可以按精确 Release 启用或停用。会话固定记录 Release 对象、Pack 版本、manifest SHA-256、内容承诺与母版本。',
              '付费 Style PNG 以 Seal 密文上传。玩家端会在解密前验证明文承诺、密文摘要、确定性 Seal id、密钥服务器策略和钱包权益；任一证据失败都会保持不可用。',
              '独立 Pack 素材可以在玩家端预览与组合；在经过审核的组合 Complete 桥完成链上部署并启用前，只要启用了独立 Pack，Complete OC 就会明确阻止。',
            ],
          },
        ],
      },
  ...
  ja: {
    ...
    articles: [
      ...
      },
      {
        ...
        category: 'publish',
        title: 'Expansion Packs',
        summary: '一つの厳密な親 Maker リリースに結び付く、独立した無料または買い切りの追加リリースを公開します。',
        sections: [
          {
            title: '独立リリースとアクセス',
            bullets: [
              '公開ごとに独立した ExpansionPackReleaseV8 が作られ、親 MakerRootV5、親 release object、親 version、manifest Blob/Quilt id、manifest SHA-256 に厳密に結び付けられます。',
              'Pack Studio は親の canvas、Renderer、Layer Tracks、Rules、Smart Color、Soul、license、その他の互換 contract を read-only で継承します。Creator が編集できるのは Pack 所有の追加 Part、Item、Style だけです。',
              'アクセスは FREE または ONE_TIME_PAID です。無料 claim または正確な一回払いにより、その Pack release に対する永久・譲渡不能・wallet-bound の ExpansionPackPassV8 が発行されます。',
              'Pack の利用には親 Base entitlement、Active な Pack、親の現在の ownership epoch と一致する admission も必要です。',
            ],
          },
          {
            title: 'Admission、境界、バージョン',
            bullets: [
              'exact Style registry の seal 後、現在の親運営者が有効な MakerControlCapV5 で Pack を admit します。Admission には親 ownership epoch が記録されます。',
              'Maker の譲渡で epoch が変わると、新運営者が再 admission するまで新規 claim、購入、Pack 利用は fail closed になります。既存 Pass と entitlement record は暗黙に失効せず保持されます。',
              'Pack は Pack 所有内容と互換な Pack 所有 rule だけを追加できます。default Recipe の置換や、親 artwork、Rules、Layer Tracks、Smart Color、Soul、license、その他の継承 contract の変更はできません。',
              'Pack 内容の変更は新しい不変 Pack version と ExpansionPackReleaseV8 を作ります。Maker の新 version は作らず、親 release や古い Pack release を書き換えません。',
            ],
            note: 'Pack は独立した identity、lifecycle、access Pass、Treasury を持つ子 release です。親 Maker release に結び付きますが、Maker の入れ子ではありません。package、runtime id、Mainnet 証跡が検証されるまで Expansion Pack v8 は fail-closed です。',
          },
          {
            title: 'Player への導入と有料素材の保護',
            bullets: [
              'Player に表示されるのは、Sui Release object、厳密な親 release、canonical Walrus manifest、完全な Style registry、wallet Pass がすべて一致する Pack だけです。同名やローカル draft だけで権限を得ることはありません。',
              'FREE Pack を claim、または ONE_TIME_PAID Pack を一度購入した後、Player でその厳密な Release を有効・無効にできます。session は Release object、Pack version、manifest SHA-256、content commitment、親 version を固定します。',
              '有料 Style PNG は Seal ciphertext として upload されます。Player は復号前に plaintext commitment、ciphertext digest、決定的 Seal id、key-server policy、wallet entitlement を検証し、証跡が失敗した Pack は利用不能のままにします。',
              '独立 Pack の素材は Player で preview・合成できます。監査済み composite Complete bridge が on-chain で deploy・enable されるまでは、独立 Pack が有効な状態の Complete OC を明示的に block します。',
            ],
          },
        ],
      },
  ...
  ko: {
    ...
    articles: [
      ...
      },
      {
        ...
        category: 'publish',
        title: 'Expansion Packs',
        summary: '하나의 정확한 상위 Maker 릴리스에 결합된 독립 무료 또는 일회성 유료 추가 릴리스를 게시합니다.',
        sections: [
          {
            title: '독립 릴리스와 접근 권한',
            bullets: [
              '게시할 때마다 독립 ExpansionPackReleaseV8이 생성되고 상위 MakerRootV5, 상위 release object, 상위 version, manifest Blob/Quilt id, manifest SHA-256에 정확히 결합됩니다.',
              'Pack Studio는 상위 canvas, Renderer, Layer Tracks, Rules, Smart Color, Soul, license 및 기타 호환 계약을 read-only로 상속합니다. Creator는 Pack 소유의 추가 Part, Item, Style만 편집합니다.',
              '접근 방식은 FREE 또는 ONE_TIME_PAID입니다. 무료 claim 또는 정확한 일회 결제로 해당 Pack release에 영구적이고 양도할 수 없는 wallet-bound ExpansionPackPassV8을 발급합니다.',
              'Pack 사용에는 상위 Base entitlement, Active Pack, 상위의 현재 ownership epoch와 일치하는 admission도 필요합니다.',
            ],
          },
          {
            title: 'Admission, 경계와 버전',
            bullets: [
              'exact Style registry를 seal한 뒤 현재 상위 운영자가 유효한 MakerControlCapV5로 Pack을 admit합니다. Admission에는 상위 ownership epoch가 기록됩니다.',
              'Maker 양도로 epoch가 바뀌면 새 운영자가 다시 admission할 때까지 새 claim, 구매 및 Pack 사용이 fail closed됩니다. 기존 Pass와 entitlement record는 조용히 취소되지 않고 보존됩니다.',
              'Pack은 Pack 소유 콘텐츠와 호환되는 Pack 소유 rule만 추가할 수 있습니다. default Recipe를 교체하거나 상위 artwork, Rules, Layer Tracks, Smart Color, Soul, license 또는 기타 상속 계약을 변경할 수 없습니다.',
              'Pack 콘텐츠 변경은 새 불변 Pack version과 ExpansionPackReleaseV8을 만듭니다. Maker 새 version을 만들거나 상위 release 또는 이전 Pack release를 다시 쓰지 않습니다.',
            ],
            note: 'Pack은 자체 identity, lifecycle, access Pass와 Treasury를 가진 독립 하위 release입니다. 상위 Maker release에 결합되지만 중첩 Maker는 아닙니다. package, runtime id, Mainnet 증거를 검증하기 전까지 Expansion Pack v8은 fail-closed입니다.',
          },
          {
            title: 'Player 설치와 유료 아트 보호',
            bullets: [
              'Player에는 Sui Release object, 정확한 상위 release, canonical Walrus manifest, 전체 Style registry, wallet Pass가 모두 일치하는 Pack만 표시됩니다. 같은 이름이나 로컬 draft만으로 접근 권한을 얻을 수 없습니다.',
              'FREE Pack을 claim하거나 ONE_TIME_PAID Pack을 한 번 구매한 뒤 Player에서 그 정확한 Release를 켜고 끌 수 있습니다. session은 Release object, Pack version, manifest SHA-256, content commitment, 상위 version을 고정합니다.',
              '유료 Style PNG는 Seal ciphertext로 업로드됩니다. Player는 복호화 전에 plaintext commitment, ciphertext digest, 결정적 Seal id, key-server policy, wallet entitlement를 검증하며 증거가 실패하면 Pack을 사용할 수 없습니다.',
              '독립 Pack 아트는 Player에서 미리 보고 조합할 수 있습니다. 검토된 composite Complete bridge가 on-chain에 배포되고 활성화되기 전에는 독립 Pack이 켜진 상태의 Complete OC를 명확히 차단합니다.',
            ],
          },
        ],
      },
  ...
  vi: {
    ...
    articles: [
      ...
      },
      {
        ...
        category: 'publish',
        title: 'Expansion Packs',
        summary: 'Phát hành bản bổ sung độc lập, miễn phí hoặc trả một lần, gắn chính xác với một release Maker cha.',
        sections: [
          {
            title: 'Release độc lập và quyền truy cập',
            bullets: [
              'Mỗi lần xuất bản tạo một ExpansionPackReleaseV8 độc lập, gắn chính xác với MakerRootV5 cha, object release cha, version cha, manifest Blob/Quilt id và manifest SHA-256.',
              'Pack Studio kế thừa ở chế độ read-only canvas, Renderer, Layer Tracks, Rules, Smart Color, Soul, license và các hợp đồng tương thích khác của bản cha. Creator chỉ sửa Part, Item và Style bổ sung thuộc Pack.',
              'Chỉ chọn FREE hoặc ONE_TIME_PAID. Claim miễn phí hoặc thanh toán một lần đúng giá sẽ cấp ExpansionPackPassV8 vĩnh viễn, không thể chuyển nhượng và gắn với wallet cho release Pack đó.',
              'Để dùng Pack còn cần entitlement Base của bản cha, Pack ở trạng thái Active và admission khớp ownership epoch hiện tại của bản cha.',
            ],
          },
          {
            title: 'Admission, ranh giới và phiên bản',
            bullets: [
              'Sau khi seal exact Style registry, người vận hành hiện tại của bản cha admit Pack bằng MakerControlCapV5 hợp lệ. Admission ghi lại ownership epoch của bản cha.',
              'Việc chuyển Maker làm đổi epoch, nên claim, mua và sử dụng Pack mới đều fail closed cho tới khi người vận hành mới admit lại. Pass và entitlement record hiện có được giữ nguyên, không bị thu hồi ngầm.',
              'Pack chỉ được thêm nội dung thuộc Pack và rule tương thích thuộc Pack. Nó không thể thay default Recipe hay sửa artwork, Rules, Layer Tracks, Smart Color, Soul, license hoặc hợp đồng kế thừa khác của bản cha.',
              'Đổi nội dung Pack tạo một Pack version bất biến mới và ExpansionPackReleaseV8 mới. Việc này không tạo Maker version mới, không ghi lại release cha hay release Pack cũ.',
            ],
            note: 'Pack là release con được quản trị độc lập, có identity, lifecycle, access Pass và Treasury riêng. Nó gắn với release Maker cha nhưng không phải Maker lồng Maker. Expansion Pack v8 giữ fail-closed cho đến khi xác minh package, runtime id và bằng chứng Mainnet.',
          },
          {
            title: 'Cài trong Player và bảo vệ hình trả phí',
            bullets: [
              'Player chỉ hiển thị Pack khi Sui Release object, release cha chính xác, Walrus manifest chuẩn hóa, toàn bộ Style registry và wallet Pass đều khớp. Trùng tên hoặc draft cục bộ không bao giờ cấp quyền.',
              'Claim Pack FREE hoặc mua Pack ONE_TIME_PAID đúng một lần, sau đó bật hay tắt đúng Release đó trong Player. Session ghim Release object, Pack version, manifest SHA-256, content commitment và version cha.',
              'PNG Style trả phí được upload dưới dạng Seal ciphertext. Trước khi giải mã, Player xác minh plaintext commitment, ciphertext digest, Seal id tất định, key-server policy và wallet entitlement; bằng chứng sai sẽ giữ Pack ở trạng thái không dùng được.',
              'Có thể preview và phối hình của Pack độc lập trong Player. Complete OC bị chặn rõ ràng khi Pack độc lập đang bật cho đến khi composite Complete bridge đã duyệt được deploy và enable on-chain.',
            ],
          },
        ],
      },
