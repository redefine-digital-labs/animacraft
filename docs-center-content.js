export const DOCS_VERSION = '0.8.1';
  ...
  en: {
    ...
    articles: [
        ...
        sections: [
          {
            ...
            bullets: [
              ...
              'Active means the on-chain Maker settings permit new authorizations, but the global Canonical Soul gate currently overrides this and remains disabled.',
              'Paused blocks new authorizations while preserving existing OCs and provenance.',
          ...
          },
          {
            ...
            bullets: [
              ...
              'Administration requires the live MakerAdminCap owner.',
              'Pause turns off on-chain minting and fee flags and sets price to zero. The previous paid settings snapshot is local-only; if it is missing in another environment, resume can restore only free settings.',
      ...
      },
      {
        ...
        summary: 'Use the limited embedded-v1 overlay inside one Maker publication.',
        sections: [
          {
            title: 'What embedded-v1 does',
            bullets: [
              'The current Creator UI can create an empty Pack, copy the selected Item into it, toggle it for preview, and delete it.',
              'Pack content is embedded in the same Maker manifest and merged into the same Sui graph during publication.',
              'It is not a separately published on-chain object and has no independent owner, price, payment, or release flow.',
              'Changing embedded content requires a new Maker version.',
            ],
          },
          {
            title: 'Schema and compatibility boundary',
            bullets: [
              ...
              'The schema and runtime understand dependencies and compatible version ranges, but the current UI is not a complete Pack editor.',
              'Run compatibility and Preflight against the exact Maker version before publishing the combined graph.',
            ],
            note: 'embedded-v1 is optional content inside one immutable Maker release, not an independent DLC marketplace or chain asset.',
          },
        ],
      },
      {
        ...
        sections: [
          {
            ...
            bullets: [
              ...
              'Walrus: immutable Maker manifest, PNGs, cover, thumbnails, Soul defaults, and release package for the purchased retention period; storage must be renewed before expiry.',
              'Sui: OCMaker provenance and state, MakerAdminCap authority, Treasury and economics, and the equivalent compiled Sui v2 rule projection.',
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'Maker publication does not register a player Recipe. Recipe authorization data is created only after the Canonical Soul gate is enabled and a player completes that authorization flow.',
            ],
  ...
  zh: {
    ...
    articles: [
        ...
        sections: [
          {
            ...
            bullets: [
              ...
              'Active 表示链上 Maker 设置允许新授权；但全局 Canonical Soul gate 当前仍关闭，并会覆盖这个状态。',
              'Paused 阻止新授权，但保留已有 OC 和来源记录。',
          ...
          },
          {
            ...
            bullets: [
              ...
              '链上管理需要当前 MakerAdminCap 持有者。',
              'Pause 会关闭链上的 minting 与 fee 开关，并把 price 设为 0；暂停前的付费配置快照只保存在本地，跨环境缺失时 resume 只能恢复免费设置。',
      ...
      },
      {
        ...
        category: 'publish',
        title: 'Expansion Packs',
        summary: '在一次 Maker 发布中使用受限的 embedded-v1 可选内容。',
        sections: [
          {
            title: 'embedded-v1 当前能做什么',
            bullets: [
              '当前 Creator UI 只能新建空 Pack、复制当前 Item、开启或关闭预览，以及删除 Pack。',
              'Pack 内容嵌入同一份 Maker manifest，并在发布时合并进同一张 Sui graph。',
              '它不是独立链上对象，也没有独立所有权、定价、付费或发布流程。',
              '修改 embedded 内容必须发布新的 Maker version。',
            ],
          },
          {
            title: 'Schema 与兼容性边界',
            bullets: [
              ...
              'Schema/runtime 已支持依赖和兼容版本范围，但当前 UI 还不是完整的 Pack 编辑器。',
              '发布合并后的 graph 前，要针对准确 Maker version 运行 compatibility 和 Preflight。',
            ],
            note: 'embedded-v1 是同一个不可变 Maker release 内的可选内容，不是独立 DLC 市场或链上资产。',
          },
        ],
      },
      {
        ...
        sections: [
          {
            ...
            bullets: [
              ...
              'Walrus：在已购买 retention 内保存不可变 Maker manifest、PNG、封面、缩略图、Soul 默认内容和发布包；到期前必须续存。',
              'Sui：OCMaker 来源与状态、MakerAdminCap 权限、Treasury 与经济配置，以及等价编译的 Sui v2 规则投影。',
          ...
          },
          {
            ...
            paragraphs: [
              ...
              '发布 Maker 不会注册玩家 Recipe；只有全局 Canonical Soul gate 启用且玩家完成授权流程后，才会创建 Recipe authorization data。',
            ],
  ...
  ja: {
    ...
    articles: [
        ...
        sections: [
          {
            ...
            bullets: [
              ...
              'Active は on-chain Maker 設定が新規 authorization を許可する状態ですが、全体の Canonical Soul gate は現在無効で、この状態より優先されます。',
              'Paused は新規 authorization を止め、既存 OC と来歴を保持します。',
          ...
          },
          {
            ...
            bullets: [
              ...
              'chain 上の管理には現在の MakerAdminCap 所有者が必要です。',
              'Pause は on-chain minting と fee flag を無効化して price を 0 にします。停止前の有料設定 snapshot はローカルだけに保存され、別環境で欠けている場合は無料設定としてのみ resume できます。',
      ...
      },
      {
        ...
        category: 'publish',
        title: 'Expansion Packs',
        summary: '一つの Maker 公開内で制限付き embedded-v1 overlay を使います。',
        sections: [
          {
            title: 'embedded-v1 で現在できること',
            bullets: [
              '現在の Creator UI は empty Pack の作成、選択中 Item のコピー、preview の有効・無効、削除だけに対応します。',
              'Pack 内容は同じ Maker manifest に埋め込まれ、公開時に同じ Sui graph へ統合されます。',
              '独立した on-chain object ではなく、個別所有権、価格、支払い、公開フローもありません。',
              '埋め込み内容の変更には新しい Maker version の公開が必要です。',
            ],
          },
          {
            title: 'Schema と互換性の境界',
            bullets: [
              'Pack はベース default Recipe の置換や、既存ベース内容の暗黙編集をできません。',
              '新しい requires は Pack 所有内容から発火し、excludes は Pack 所有内容を含む必要があります。',
              'Schema/runtime は依存関係と互換バージョン範囲を扱えますが、現在の UI は完全な Pack editor ではありません。',
              '統合 graph の公開前に、正確な Maker version に対して compatibility と Preflight を実行します。',
            ],
            note: 'embedded-v1 は一つの不変 Maker release 内の任意コンテンツであり、独立 DLC marketplace や chain asset ではありません。',
          },
        ],
      },
      {
        ...
        sections: [
          {
            ...
            bullets: [
              ...
              'Walrus：購入した retention 期間中の不変 Maker manifest、PNG、cover、thumbnail、Soul 初期値、release package。期限前の更新が必要です。',
              'Sui：OCMaker 来歴と状態、MakerAdminCap 権限、Treasury と経済設定、等価に compiled された Sui v2 ルール投影。',
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'Maker 公開だけでは player Recipe は登録されません。Recipe authorization data は Canonical Soul gate が有効になり、player が authorization flow を完了した後だけ作成されます。',
            ],
  ...
  ko: {
    ...
    articles: [
        ...
        sections: [
          {
            ...
            bullets: [
              ...
              'Active는 on-chain Maker 설정이 새 authorization을 허용한다는 뜻이지만, 전역 Canonical Soul gate가 현재 꺼져 있어 이 상태보다 우선합니다.',
              'Paused는 새 authorization을 막고 기존 OC와 출처를 보존합니다.',
          ...
          },
          {
            ...
            bullets: [
              ...
              'chain 관리는 현재 MakerAdminCap 소유자가 수행해야 합니다.',
              'Pause는 on-chain minting과 fee flag를 끄고 price를 0으로 만듭니다. 중단 전 유료 설정 snapshot은 로컬에만 저장되며 다른 환경에서 없으면 무료 설정으로만 resume할 수 있습니다.',
      ...
      },
      {
        ...
        category: 'publish',
        title: 'Expansion Packs',
        summary: '하나의 Maker 게시 안에서 제한된 embedded-v1 overlay를 사용합니다.',
        sections: [
          {
            title: 'embedded-v1에서 현재 가능한 것',
            bullets: [
              '현재 Creator UI는 empty Pack 생성, 선택 Item 복사, preview 켜기/끄기, 삭제만 지원합니다.',
              'Pack 콘텐츠는 같은 Maker manifest에 포함되고 게시 때 같은 Sui graph에 병합됩니다.',
              '별도 on-chain object가 아니며 독립 소유권, 가격, 결제 또는 게시 흐름이 없습니다.',
              'embedded 콘텐츠 변경은 새 Maker version 게시가 필요합니다.',
            ],
          },
          {
            title: 'Schema와 호환성 경계',
            bullets: [
              'Pack은 기본 default Recipe를 교체하거나 기존 기본 콘텐츠를 몰래 수정할 수 없습니다.',
              '새 requires는 Pack 소유 콘텐츠에서 시작하고 excludes는 Pack 콘텐츠를 포함해야 합니다.',
              'Schema/runtime은 의존성과 호환 버전 범위를 이해하지만 현재 UI는 완전한 Pack editor가 아닙니다.',
              '병합된 graph를 게시하기 전에 정확한 Maker version에 대해 compatibility와 Preflight를 실행합니다.',
            ],
            note: 'embedded-v1은 하나의 불변 Maker release 안의 선택 콘텐츠이며 독립 DLC marketplace나 chain asset이 아닙니다.',
          },
        ],
      },
      {
        ...
        sections: [
          {
            ...
            bullets: [
              ...
              'Walrus: 구매한 retention 기간의 불변 Maker manifest, PNG, cover, thumbnail, Soul 기본값, release package. 만료 전 갱신이 필요합니다.',
              'Sui: OCMaker 출처와 상태, MakerAdminCap 권한, Treasury와 경제 설정, 동등하게 compiled된 Sui v2 규칙 투영.',
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'Maker 게시만으로 player Recipe가 등록되지는 않습니다. Recipe authorization data는 Canonical Soul gate가 켜지고 player가 authorization flow를 완료한 뒤에만 생성됩니다.',
            ],
  ...
  vi: {
    ...
    articles: [
        ...
        sections: [
          {
            ...
            bullets: [
              ...
              'Active nghĩa là cài đặt Maker on-chain cho phép authorization mới, nhưng Canonical Soul gate toàn cục hiện vẫn tắt và ghi đè trạng thái này.',
              'Paused chặn authorization mới nhưng giữ OC và nguồn gốc hiện có.',
          ...
          },
          {
            ...
            bullets: [
              ...
              'Quản trị chain yêu cầu chủ sở hữu MakerAdminCap hiện tại.',
              'Pause tắt on-chain minting và fee flag, đồng thời đặt price về 0. Snapshot cấu hình trả phí trước khi dừng chỉ lưu cục bộ; nếu thiếu ở môi trường khác, resume chỉ có thể khôi phục cấu hình miễn phí.',
      ...
      },
      {
        ...
        category: 'publish',
        title: 'Expansion Packs',
        summary: 'Dùng overlay embedded-v1 giới hạn trong một lần xuất bản Maker.',
        sections: [
          {
            title: 'embedded-v1 hiện làm được gì',
            bullets: [
              'Creator UI hiện chỉ tạo Pack rỗng, sao chép Item đang chọn, bật/tắt preview và xóa Pack.',
              'Nội dung Pack được nhúng trong cùng Maker manifest và hợp nhất vào cùng Sui graph khi xuất bản.',
              'Pack không phải on-chain object riêng và không có chủ sở hữu, giá, thanh toán hay luồng xuất bản độc lập.',
              'Muốn đổi nội dung embedded phải phát hành Maker version mới.',
            ],
          },
          {
            title: 'Ranh giới schema và tương thích',
            bullets: [
              ...
              'Schema/runtime hiểu phụ thuộc và phạm vi phiên bản tương thích, nhưng UI hiện không phải Pack editor đầy đủ.',
              'Chạy compatibility và Preflight với đúng Maker version trước khi xuất bản graph đã hợp nhất.',
            ],
            note: 'embedded-v1 là nội dung tùy chọn trong một Maker release bất biến, không phải DLC marketplace hay chain asset độc lập.',
          },
        ],
      },
      {
        ...
        sections: [
          {
            ...
            bullets: [
              ...
              'Walrus: Maker manifest bất biến, PNG, cover, thumbnail, mặc định Soul và release package trong retention đã mua; phải gia hạn trước khi hết hạn.',
              'Sui: nguồn gốc và trạng thái OCMaker, quyền MakerAdminCap, Treasury và kinh tế, cùng bản chiếu quy tắc Sui v2 compiled tương đương.',
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'Xuất bản Maker không đăng ký Recipe của người chơi. Recipe authorization data chỉ được tạo sau khi Canonical Soul gate bật và người chơi hoàn tất authorization flow.',
            ],
